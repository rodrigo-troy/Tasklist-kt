...
class TasklistTest : StageTest<Any>() {
    ...
    fun tasklistTest05(): CheckResult {
        ...
        if (!co.start("Input an action (add, print, end):"))
            return CheckResult(false,
                               "Your output should contain \"Input an action (add, print, end):\"")
        for (s in inputStrings) {
            if (!co.input(s,
                          "The input action is invalid"))
                return CheckResult(false,
                                   "Your output should contain \"The input action is invalid\"")
    ...
    fun tasklistTest09(): CheckResult {
        val inputStrings = listOf("normal",
                                  "Critical",
                                  "low",
                                  "high",
                                  " ")
    ...
    fun tasklistTest10(): CheckResult {
        val inputStrings = listOf("2021-2-29",
                                  "2021-13-1",
                                  "2021-12-32",
                                  "thisDay",
                                  " ")
        ...
        for (s in inputStrings) {
            if (!co.input(s,
                ...
                return CheckResult(false,
                                   "Your output should contain \"The input date is invalid\"")
    ...
    fun tasklistTest11(): CheckResult {
        ...
        for (s in inputStrings) {
            if (!co.input(s,
                ...
                return CheckResult(false,
                                   "Your output should contain \"The input time is invalid\"")
    ...
    fun tasklistTest13(): CheckResult {
        ...
        val outputStrings = arrayListOf(
                arrayOf("1  2022-01-14 17:00 H",
                        "   See my dentist on 14/1/22"),
                arrayOf("2  2022-12-20 17:00 N",
                        "   Cinema: get tickets",
                        "   Check movie reviews"),
                arrayOf("3  2021-12-13 19:00 N",
                        "   Supermarket",
                        "   Chocolates",
                        "   flour",
                        "   oranges"),
                arrayOf("4  2022-01-20 12:00 L",
                        "   Buy book"),
                arrayOf("5  2022-01-08 12:00 N",
                        "   Check new software"),
                arrayOf("6  2021-01-20 16:00 C",
                        "   Fill car tank"),
                arrayOf("7  2022-01-22 18:15 C",
                        "   Pay phone bill"),
                arrayOf("8  2022-01-22 18:15 L",
                        "   Pay water bill"),
                arrayOf("9  2022-01-22 08:05 L",
                        "   Buy flowers"),
                arrayOf("10 2021-12-19 12:00 C",
                        "   Fix printer"),
                arrayOf("11 2021-12-01 12:00 H",
                        "   Change site",
                        "   Use Christmas theme"),
                arrayOf("12 2022-02-22 12:00 L",
                        "   Present for friend birthday")
        )
